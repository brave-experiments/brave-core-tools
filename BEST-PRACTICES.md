...
- **[Brave Style Guide](./docs/best-practices/style-guide.md)** - Voice, capitalization, punctuation, product naming, accessibility, privacy/security terms, product messaging
