#!/usr/bin/env python3
"""Discover best-practice documents and determine which apply to a set of changed files.

Scans the best-practices directory and uses filename conventions to match
documents to file-type categories. Documents that don't match any specific
category are treated as "always applicable".
...
Output (JSON):
    [
      {"doc": "coding-standards.md", "path": "/full/path/coding-standards.md", "category": "cpp"},
      {"doc": "architecture.md", "path": "/full/path/architecture.md", "category": "always"},
      ...
    ]
...
CATEGORY_FILE_PATTERNS = {
    ...
    "test": {
        ...
        "path_contains": [],
        "name_patterns": [
            "_test.cc", "_browsertest.cc", "_unittest.cc",
            ".test.ts", ".test.tsx",
        ],
    },
    "chromium_src": {
    ...
    "nala": {
        "extensions": {".icon", ".svg"},
        "path_contains": [
            "res/drawable", "res/values", "res/values-night",
